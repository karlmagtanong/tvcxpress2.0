			...
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="mb-3">
								<label class="form-label">Agency Landline<span style="color:red">&nbsp*</span></label>
									...
									<div class="col-sm-12">
										<div>
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" name="TvcOrder[billing_upload_type]" id="billing_upload_type1" value="1">
												<label class="form-check-label" for="billing_upload_type1">
													Upload Now
												</label>
											</div>
											<div class="form-check form-check-inline">
												<input type="radio" class="form-check-input" name="TvcOrder[billing_upload_type]" id="billing_upload_type2" value="2">
						...
						<div class="col-sm-12">
							<div class="row mb-3">
								<div>
									...
									<div class="form-check form-check-inline">
										<input type="radio" class="form-check-input" name="TvcOrder[mode_payment]" id="mode_payment8" value="8">
					...
					<div class="row mb-3">
						<div class="col-sm-3">
							<div class="mb-3">
								...
								<?php echo $form->textField($model, 'delivery_company', ['size' => 60, 'maxlength' => 255, 'class' => 'form-control'], required); ?>
							</div>
						</div><!-- Col -->
						<div class="col-sm-3">
							<div class="mb-3">
...
<script>
	...
	function submitform() {
		...
		$.ajax({
			url: '<?php echo $this->createUrl('TvcOrder/CreateTran'); ?>',
			type: 'POST',
			data: new FormData(document.getElementById("tvc-order-form")),
			contentType: false,
			cache: false,
