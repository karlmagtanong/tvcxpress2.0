							...
							<div class="row mb-3" id="upload_billing_show_later">
								<div class="row">
									<div class="col-sm-6 mb-3">
										...
										<input size="60" maxlength="255" class="form-control" name="TvcOrder[billing_upload_date]" id="TvcOrder_billing_upload_date" type="date" value="<?php echo $model->billing_upload_date ?>">
									</div>
									<div class="col-sm-6 mb-3">
